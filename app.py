...
class Window(QWidget):
    ...
    def insert_plot(self): #insert graph canvas
    ...
    def update_plot(self):  #graph plotting
        ...
        s = (2*(t**3) - 3*(t**2) + 1)*p1 + (-2*(t**3) + 3*(t**2))*p2 + (t**3 - 2*(t**2) + t)*r1 + (t**3 - t**2)*r2  #Hermite curve equation 
